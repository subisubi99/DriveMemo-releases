...
### ⬇ [DriveMemo 0.9.52 받기 (DriveMemo-0.9.52.zip)](https://github.com/subisubi99/DriveMemo-releases/raw/main/DriveMemo-0.9.52.zip)
...
- 여러 메모를 골라 목록 순서대로 하나로 합치기. 회의록·일지·긴 글의 화별 원고를 한 파일로 묶을 때 좋습니다. (txt 사본도 자동 저장)
...
- DriveMemo가 인터넷에 접속하는 경우는 두 가지뿐입니다.
  - **업데이트 확인**: 이 페이지의 버전 정보 파일(`latest.txt`)을 읽습니다. 환경 설정에서 자동 확인을 끌 수 있습니다.
  - **의견 보내기**: 직접 적어서 [보내기]를 누를 때만, 적은 내용과 DriveMemo·윈도우 버전을 보냅니다.
